 ...
 * @export
 */
export declare type CreateEmbeddingRequestInput =
	| Array<any>
	| Array<number>
	| Array<string>
	| string;
 ...
 * @export
 */
export declare const OpenAIApiAxiosParamCreator: (
 ...
 * @export
 */
export declare const OpenAIApiFactory: (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance
) => {
...
export declare class OpenAIApi extends BaseAPI {
	...
	cancelFineTune(
		fineTuneId: string,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<FineTune, any>>;
	/**
	 *
	 * @summary Answers the specified question using the provided documents and examples.  The endpoint first [searches](/docs/api-reference/searches) over provided documents or files to find relevant context. The relevant context is combined with the provided examples and question to create the prompt for [completion](/docs/api-reference/completions).
	 * @param {CreateAnswerRequest} createAnswerRequest
	...
	createAnswer(
		createAnswerRequest: CreateAnswerRequest,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<CreateAnswerResponse, any>>;
	/**
	 *
	 * @summary Classifies the specified `query` using provided examples.  The endpoint first [searches](/docs/api-reference/searches) over the labeled examples to select the ones most relevant for the particular query. Then, the relevant examples are combined with the query to construct a prompt to produce the final label via the [completions](/docs/api-reference/completions) endpoint.  Labeled examples can be provided via an uploaded `file`, or explicitly listed in the request using the `examples` parameter for quick tests and small scale use cases.
	 * @param {CreateClassificationRequest} createClassificationRequest
	...
	createClassification(
		createClassificationRequest: CreateClassificationRequest,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<CreateClassificationResponse, any>>;
	/**
	 *
	 * @summary Creates a completion for the provided prompt and parameters
	 * @param {CreateCompletionRequest} createCompletionRequest
	...
	createEdit(
		createEditRequest: CreateEditRequest,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<CreateEditResponse, any>>;
	/**
	 *
	 * @summary Creates an embedding vector representing the input text.
	 * @param {CreateEmbeddingRequest} createEmbeddingRequest
	...
	createEmbedding(
		createEmbeddingRequest: CreateEmbeddingRequest,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<CreateEmbeddingResponse, any>>;
	/**
	 *
	 * @summary Upload a file that contains document(s) to be used across various endpoints/features. Currently, the size of all the files uploaded by one organization can be up to 1 GB. Please contact us if you need to increase the storage limit.
	 * @param {File} file Name of the [JSON Lines](https://jsonlines.readthedocs.io/en/latest/) file to be uploaded.  If the &#x60;purpose&#x60; is set to \\\&quot;fine-tune\\\&quot;, each line is a JSON record with \\\&quot;prompt\\\&quot; and \\\&quot;completion\\\&quot; fields representing your [training examples](/docs/guides/fine-tuning/prepare-training-data).
	...
	createFile(
		...
		purpose: string,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<OpenAIFile, any>>;
	/**
	 *
	 * @summary Creates a job that fine-tunes a specified model from a given dataset.  Response includes details of the enqueued job including job status and the name of the fine-tuned models once complete.  [Learn more about Fine-tuning](/docs/guides/fine-tuning)
	 * @param {CreateFineTuneRequest} createFineTuneRequest
	...
	createModeration(
		createModerationRequest: CreateModerationRequest,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<CreateModerationResponse, any>>;
	/**
	 *
	 * @summary The search endpoint computes similarity scores between provided query and documents. Documents can be passed directly to the API if there are no more than 200 of them.  To go beyond the 200 document limit, documents can be processed offline and then used for efficient retrieval at query time. When `file` is set, the search endpoint searches over all the documents in the given file and returns up to the `max_rerank` number of documents. These documents will be returned along with their search scores.  The similarity score is a positive score that usually ranges from 0 to 300 (but can sometimes go higher), where a score above 200 usually means the document is semantically similar to the query.
	 * @param {string} engineId The ID of the engine to use for this request.  You can select one of &#x60;ada&#x60;, &#x60;babbage&#x60;, &#x60;curie&#x60;, or &#x60;davinci&#x60;.
	...
	createSearch(
		...
		createSearchRequest: CreateSearchRequest,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<CreateSearchResponse, any>>;
	/**
	 *
	 * @summary Delete a file.
	 * @param {string} fileId The ID of the file to use for this request
	...
	deleteFile(
		fileId: string,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<DeleteFileResponse, any>>;
	/**
	 *
	 * @summary Delete a fine-tuned model. You must have the Owner role in your organization.
	 * @param {string} model The model to delete
	...
	deleteModel(
		model: string,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<DeleteModelResponse, any>>;
	/**
	 *
	 * @summary Returns the contents of the specified file
	 * @param {string} fileId The ID of the file to use for this request
	...
	listEngines(
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<ListEnginesResponse, any>>;
	/**
	 *
	 * @summary Returns a list of files that belong to the user\'s organization.
	 * @param {*} [options] Override http request option.
	...
	listFiles(
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<ListFilesResponse, any>>;
	/**
	 *
	 * @summary Get fine-grained status updates for a fine-tune job.
	 * @param {string} fineTuneId The ID of the fine-tune job to get events for.
	...
	listFineTuneEvents(
		...
		stream?: boolean,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<ListFineTuneEventsResponse, any>>;
	/**
	 *
	 * @summary List your organization\'s fine-tuning jobs
	 * @param {*} [options] Override http request option.
	...
	listFineTunes(
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<ListFineTunesResponse, any>>;
	/**
	 *
	 * @summary Lists the currently available models, and provides basic information about each one such as the owner and availability.
	 * @param {*} [options] Override http request option.
	...
	listModels(
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<ListModelsResponse, any>>;
	/**
	 *
	 * @summary Retrieves a model instance, providing basic information about it such as the owner and availability.
	 * @param {string} engineId The ID of the engine to use for this request
	...
	retrieveEngine(
		engineId: string,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<Engine, any>>;
	/**
	 *
	 * @summary Returns information about a specific file.
	 * @param {string} fileId The ID of the file to use for this request
	...
	retrieveModel(
		model: string,
		options?: AxiosRequestConfig
	): Promise<import('axios').AxiosResponse<Model, any>>;
}
